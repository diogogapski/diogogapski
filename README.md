...
Sou estudante de Ciência da Computação no IFPR e focado em construir **soluções inteligentes**, **agentes de IA** e **sistemas web seguros de alta performance**. Minha paixão é transformar problemas complexos em produtos escaláveis e eficientes.

Atuo no desenvolvimento de **automações avançadas**, **web scraping** e **plataformas full-stack** modernas.
...
<p align="left">
  ...
  <a href="https://diogogapski.netlify.app">
    <img src="https://img.shields.io/badge/Portfolio-DIOGOGAPSKI.NETLIFY.APP-00ADEE?style=for-the-badge&logo=netlify" />
  </a>
</p>
